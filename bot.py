...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (f"🤖 *{TOKEN_NAME} Multi-Chain Bot*\n\n"
...
async def router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if d == "m_main":
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton("🔄 REFRESH", callback_data="m_wallet")],
                                   [InlineKeyboardButton("⬅️ BACK", callback_data="m_main")]])
        ...
        try:
            ...
            text = f"✅ *Mint Created!*\n\n`{mint_addr}`\n\nTx: `{tx[:20]}...`"
            kb = InlineKeyboardMarkup([[InlineKeyboardButton("🪙 MINT SUPPLY", callback_data="l_mint")],
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton("🔗 OPEN SMITHII", url=f"https://tools.smithii.io/liquidity-pool/solana?base={mint}")],
                                   [InlineKeyboardButton("⬅️ BACK", callback_data="m_launch")]])
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton("🔗 OPEN", url=f"https://tools.smithii.io/liquidity-pool/solana?base={mint}")],
        ...
        text = (f"🧮 *Profit Calc*\n\n"
                ...
                f"How much?")
        kb = InlineKeyboardMarkup([[InlineKeyboardButton("🧮 CALCULATE", callback_data="p_calc")],
                                   [InlineKeyboardButton("⬅️ BACK", callback_data="m_main")]])
        await query.edit_message_text(text, parse_mode="Markdown", reply_markup=kb)
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton("🔄 RECALC", callback_data="p_calc")],
