...
# RPC ENDPOINTS
# ═══════════════════════════════════════════════════════
RPC_SOLANA = os.getenv("RPC_SOLANA", f"https://mainnet.helius-rpc.com/?api-key={HELIUS_API_KEY or ''}")
...
if not JUPITER_API_KEY:
    raise Exception("Missing JUPITER_API_KEY - get at https://station.jup.ag/docs/apis/")
if not HELIUS_API_KEY:
    raise Exception("Missing HELIUS_API_KEY - get at https://helius.dev/")
if not SEED_PHRASE and not PRIVATE_KEY_SOL:
    raise Exception("Missing SEED_PHRASE or PRIVATE_KEY_SOL")
