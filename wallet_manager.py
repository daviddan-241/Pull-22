...
class MultiChainWallet:
    ...
    Derivation paths:
    - Solana: m/44'/501'/0'/0'
    - EVM (ETH/BSC/Base/Arbitrum): m/44'/60'/0'/0/0
    """
    ...
    def solana_pubkey(self):
        return str(self._sol_keypair.pubkey()) if self._sol_keypair else None
    ...
    def eth_address(self):
        return self._eth_account.address if self._eth_account else None
...
def generate_volume_wallets(count: int = 5):
    """Generate fresh burner wallets for volume."""
    wallets = []
